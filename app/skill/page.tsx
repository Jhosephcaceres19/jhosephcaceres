...
export default function page() {
  return (
    <div>
      <Navbar />
      <div className="flex flex-col items-center min-h-screen bg-gradient-to-b from-black via-sky-900 to-sky-600 text-white">
        <div className="mt-20">
              ...
              <div className="flex flex-col px-6 py-8 items-center justify-center space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-violet-600 dark:text-gray-50">
                ...
                <div className="flex space-x-2 sm:space-x-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="leading-snug">
                      Poseo una sólida capacidad de liderazgo, que me permite
                      guiar y motivar equipos hacia el logro de objetivos
                      comunes. Mi enfoque se basa en inspirar confianza y
                      fomentar un ambiente colaborativo, asegurando que cada
                      miembro del equipo se sienta valorado y comprometido con
                ...
                <div className="flex space-x-2 sm:space-x-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="leading-snug">
                      Mi habilidad para el trabajo en equipo me permite
                      integrarme de manera efectiva con otros, aprovechando
                      diversas perspectivas para alcanzar metas comunes.
                      Colaboro de manera proactiva, escuchando y aportando
                      ideas, y buscando siempre la mejor manera de coordinar
                      esfuerzos para lograr el éxito colectivo.
                    </p>
                  </div>
                </div>
              </div>
              <div className="lg:w-1/2 xl:w-3/5 dark:bg-gray-100">
                <div className="flex items-center justify-center p-4 md:p-8 lg:p-12">
                  <Image
                    ...
                    width="400"
                    height="400"
                    className="rounded-3xl shadow-lg w-full object-cover dark:bg-gray-500 aspect-video sm:min-h-96"
                  />
                </div>
              </div>
            </div>
